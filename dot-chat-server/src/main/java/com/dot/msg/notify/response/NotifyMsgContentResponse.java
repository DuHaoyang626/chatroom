package com.dot.msg.notify.response;
...
@Schema(name = "EntNotifyMsgContentResponse", description = "通知消息内容请求对象")
public class NotifyMsgContentResponse implements Serializable {
